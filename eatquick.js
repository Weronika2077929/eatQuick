...
function refreshMap(what){
  ...
  for(var i = 0; i < what.length; i++){
    string = string + what[i].Name + ", "
      ...
      $("#searchResults").append("<div class='panel panel-success'><div class='panel-heading'><a id='resultbutton" + i + "'' href=\"#restaurantProfile\">" + what[i].Name + "</a></div><div class='panel-body'><table width=100%><tr><td>"+
      what[i].Address+ "<br>"+
      what[i].Postcode + "<br>" +
